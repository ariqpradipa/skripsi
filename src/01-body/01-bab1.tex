...
\begin{itemize}
      ...
      \item Panduan Konfigurasi Hypervisor KVM

            Memberikan rekomendasi konfigurasi hypervisor KVM terbatas pada pengujian dalam penelitian dalam rangka meningkatkan kinerja layanan Cloud Computing Infrastructure as a Service (IaaS).
\end{itemize}
