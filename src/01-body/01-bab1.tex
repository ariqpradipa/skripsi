...
\section{Tujuan}
%-----------------------------------------------------------------------------%
%Penelitian ini bertujuan untuk menganalisis performa hypervisor KVM yang telah di-tuning, terutama dalam konteks penggunaan Apache CloudStack, dengan fokus pada tugas kompresi video menggunakan HandBrake. Tujuan utama adalah mengevaluasi apakah konfigurasi default hypervisor KVM sudah optimal dan efisien, serta memahami dampak tuning terhadap performa sistem operasi \f{guest}. Hasil penelitian ini diharapkan memberikan wawasan praktis bagi pengelola sistem yang menggunakan Apache CloudStack di lingkungan produksi, serta panduan untuk optimalisasi hypervisor KVM guna meningkatkan kinerja layanan \cc\ \f{Infrastructure as a Service} (IaaS).%

Penelitian ini berfokus pada analisis performa hypervisor KVM setelah proses tuning, khususnya dalam penggunaan Apache CloudStack, dengan perhatian khusus pada kompresi video menggunakan HandBrake. Dengan tujuan sebagai berikut:
