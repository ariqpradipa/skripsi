...
Kita dapat mengaktifkan flag tersebut untuk digunakan oleh \vm\ kita yang menggunakan hypervisor KVM. Untuk melakukan tuning kita dapat menggunakan tools virsh untuk mengubah konfigurasi \vm dari CloudStack. Secara default konfigurasi dari \vm di CloudStack akan seperti ini:
