...
%-----------------------------------------------------------------------------%
\subsection{Pengujian Kompresi Video}
%-----------------------------------------------------------------------------%
\begin{listing}[H]
    \begin{minted}{bash}
    #!/bin/bash
...
%-----------------------------------------------------------------------------%
\subsection{Pengujian Validasi Integritas File}
%-----------------------------------------------------------------------------%
\begin{listing}[H]
    \begin{minted}{python}
    import os
...
% Dimana:
% \begin{itemize}
%     \item $\text{Speedup}$ adalah percepatan teoretis dari sistem setelah perubahan.
%     \item $P$ adalah proporsi dari sistem yang mendapatkan manfaat dari perubahan (dinyatakan sebagai pecahan antara 0 dan 1).
%     \item $S$ adalah percepatan dari bagian yang mendapatkan manfaat dari perubahan.
% \end{itemize}
